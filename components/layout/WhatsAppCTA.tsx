...
export default function WhatsAppCTA() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-primary-dark shadow-lg transition hover:opacity-90"
    >
