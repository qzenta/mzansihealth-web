  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
      <a
        ...
        aria-label={`Chat with us on WhatsApp (alternate number, ${siteConfig.whatsappSecondaryNumber})`}
        className="flex items-center gap-2 rounded-full bg-[#25D366]/85 px-3 py-2 text-xs font-semibold text-primary-dark shadow-lg transition hover:opacity-90"
      >
        <WhatsAppIcon />
        Alt line
      </a>
      <a
        ...
        className="flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-primary-dark shadow-lg transition hover:opacity-90"
      >
        <WhatsAppIcon />
        WhatsApp
      </a>
